MERGE INTO restaurant_table (id, table_name, capacity) KEY (id) VALUES
  (1, 'Tisch 1', 2),
  (2, 'Tisch 2', 2),
  (3, 'Tisch 3', 4),
  (4, 'Tisch 4', 4),
...
MERGE INTO menu_item (id, name, description, price, category, image_url, available) KEY (id) VALUES
  ...
  (5, 'Caesar Salad', 'RÃ¶mersalat, Croutons, Parmesan, Caesar-Dressing.', 8.90, 'STARTER', '/img/CeasarSalad.jpg', true),
  (6, 'Burrata Bowl', 'Burrata, OfengemÃ¼se, Pesto & Focaccia.', 13.20, 'STARTER', '/img/Burrata.jpg', true),
  ...
  (10, 'Hauswein', '0,2l WeiÃŸwein vom Weingut.', 5.20, 'DRINK', '/img/wine.jpg', true);
