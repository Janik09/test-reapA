...
export const api = {
  ...
  createMenuItem: (payload) => request('/menu', { method: 'POST', body: JSON.stringify(payload) }),
  deleteMenuItem: (id) => request(`/menu/${id}`, { method: 'DELETE' }),
  deleteAllMenuItems: () => request('/menu', { method: 'DELETE' }),
  ...
  deleteAllReservations: () => request('/reservations', { method: 'DELETE' }),
  ...
  deleteAllOrders: () => request('/orders', { method: 'DELETE' }),
